...
export class HelperBuilder<T> {
  ...
  getVisible = (name: string) => {
    return get(this.state.visibles, name)
  }

  getTouched = (name: string) => {
    return get(this.state.toucheds, name)
  }

  getDisplay = (name: string) => {
    return get(this.state.displays, name)
  }

  getStatus = (name: string) => {
    return get(this.state.statuses, name)
  }

  getPendding = (name: string) => {
    return get(this.state.penddings, name)
  }
